...
* **17:00 - 17:30** | Project Demonstrations & Live Judging
* **17:30 - 18:00+** | Winner Announcement, Pizza & Celebratory Drinks 🍕🥤
...
* Extracting critical deadlines, exam dates, and milestones directly into a clean calendar format.
...
* A simple UI with a pre-configured 'toolkit' connection to hook up your AI agents and Information Retrieval components seamlessly.
* Open flexibility: You are free to expand this framework or build your own custom pipeline if your solution requires it.

---

## 🏆 Prizes
We have awesome individual rewards up for grabs for the top 3 teams:
* **🥇 First Place:** Individual **bol.com gift cards** (€20 per person)
* **🥈 Second Place:** A curated, must-read **book about Artificial Intelligence** for each team member.
* **🥉 Third Place:** Individual **De Fusie after-study drink-vouchers** to celebrate your hard work.
...
* **Food & Entry:** Pizza and drinks are included. *(Note: A small entrance fee adjustment applies depending on your pizza preference during sign-up).*
...
Are you ready to hack your curriculum? See you on Friday, June 12th in the Snellius Building!
